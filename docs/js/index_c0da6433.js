...
exports = module.exports = __webpack_require__(/*! ../../../node_modules/css-loader/dist/runtime/api.js */ "./node_modules/css-loader/dist/runtime/api.js")(false);
// Module
exports.push([module.i, ".loading-wrap {\n  position: absolute;\n  left: 0;\n  top: 0;\n  right: 0;\n  bottom: 0;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n  -ms-flex-pack: center;\n  justify-content: center;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  align-items: center;\n  z-index: 999;\n}\n\n.loading-wrap .inner {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n  -ms-flex-pack: center;\n  justify-content: center;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  align-items: center;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n  -ms-flex-direction: column;\n  flex-direction: column;\n}\n\n.loading-wrap .inner .load-icon {\n  font-size: 0.96rem;\n  color: #a0b7fd;\n  -webkit-animation: loading 1s infinite linear;\n  animation: loading 1s infinite linear;\n}\n\n.loading-wrap .inner P {\n  font-size: 0.373333rem;\n  color: #999;\n}\n\n@-webkit-keyframes loading {\n  from {\n    -webkit-transform: rotate(0deg);\n    transform: rotate(0deg);\n  }\n\n  to {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n  }\n}\n\n@keyframes loading {\n  from {\n    -webkit-transform: rotate(0deg);\n    transform: rotate(0deg);\n  }\n\n  to {\n    -webkit-transform: rotate(360deg);\n    transform: rotate(360deg);\n  }\n}", ""]);
...
exports.default = {
  name: 'MoreLoading',
  _tpl: function _tpl(text, loading) {
    return (0, _utils.tplReplace)(_index2.default, {
      text: text,
      loading: loading ? 'block' : 'none'
    });
  },
  add: function add(oWrap, loading) {
    var oMoreLoading = document.querySelector('.more-loading');
    if (!oMoreLoading) {
      var _tpl2 = this._tpl(loading ? '正在加载中' : '没有更多新闻了', loading);
      oWrap.innerHTML += _tpl2;
    }
  },
  remove: function remove(oWrap) {
    var oMoreLoading = document.querySelector('.more-loading');
...
var __t, __p = '';
with (obj) {
__p += '<div class="more-loading">\r\n    <span class="iconfont icon-jiazaizhong3" style="display: {{loading}};"></span>\r\n    <p>{{text}}</p>\r\n</div>';
...
exports.default = {
  ...
  tpl: function tpl(data) {
    var itemList = '';
    data.forEach(function (_ref, index) {
      var type = _ref.type,
          title = _ref.title;
  ...
  changeTab: function changeTab(index, setType) {
    var items = document.querySelectorAll('.nav .item');
    this._curIdx = index;
...
var __t, __p = '';
with (obj) {
__p += '<div class="nav">\r\n    <div class="scroll">\r\n        <div class="nav-wrapper" style="width: {{ width }}rem">\r\n            {{ itemList }}\r\n        </div>\r\n    </div>\r\n</div>';
...
var __t, __p = '';
with (obj) {
__p += '<div class="item {{ current }}" data-type="{{ type }}">{{ title }}</div>';
...
var __t, __p = '';
with (obj) {
__p += '<div class="loading-wrap">\r\n    <div class="inner">\r\n        <span class="iconfont icon-jiazaizhong1 load-icon"></span>\r\n        <p>{{message}}</p>\r\n    </div>\r\n</div>';
...
(function (doc) {
      ...
      return _regenerator2.default.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              newsWrapper.innerHTML = _PageLoading2.default.tpl('加载新闻中');
              _context2.next = 7;
              return (0, _services.getNewsList)(type);

            case 7:
              res = _context2.sent;

              if (res.error_code === 0) {
                newsData[type] = (0, _utils.setPageData)(res.result.data, count);
              }
              setTimeout(function () {
  ...
  function render() {
    ...
    var navbar = _NavBar2.default.tpl(_data.NEWS_TYPE);
    var newsWrapperTpl = _NewsList2.default.wrapperTpl(77 / 37.5);
  ...
  function bindEvent() {
    ...
    window.addEventListener('scroll', _utils.srcollToBottom.bind(null, getMoreList), false);
  ...
  function setType(type, newsList) {
    ...
    var newsList = _NewsList2.default.tpl({
      data: data,
      pageNum: pageNum
    });
    config.isLoading = false;
    _MoreLoading2.default.remove();
  ...
  function getMoreList() {
    ...
    if (config.pageNum >= newsData[type].length) {
      _MoreLoading2.default.add(newsWrapper, false);
    } else {
      _MoreLoading2.default.add(newsWrapper, true);
...
http.interceptors.request.use(function (config) {
  config.data = _qs2.default.stringify(config.data); // 转为formdata数据格式
  return config;
}, function (error) {
  return _promise2.default.error(error);
});
...
http.interceptors.response.use(function (response) {
  ...
  if (!window.navigator.onLine) {
    document.body.innerHTML = _NoDataTip2.default.tpl('icon-duanwang', '您的网络似乎好像出了问题');
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _http2.default.post('/Juhe/getNewsList', {
              field: type
            });
...
/******/ });
//# sourceMappingURL=index_c0da6433.js.map