...
// Module
exports.push([module.i, ".follow-wrap {\n  position: fixed;\n  right: 0;\n  top: 0;\n  z-index: 999;\n  width: 1.066667rem;\n  height: 1.066667rem;\n  border: none;\n  outline: none;\n  background-color: transparent;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n  -ms-flex-pack: center;\n  justify-content: center;\n  -webkit-box-align: center;\n  -ms-flex-align: center;\n  align-items: center;\n}\n\n.follow-wrap i {\n  font-size: 0.48rem;\n  color: yellow;\n}", ""]);
...
exports.default = {
  ...
  bindEvent: function bindEvent(doFollow) {
    var oFollow = document.querySelector('.follow-wrap i');
    oFollow.addEventListener('click', this._setFllow.bind(this, oFollow, doFollow), false);
  },
  _setFllow: function _setFllow(oFollow, doFollow) {
    // console.log(this)
...
exports.default = {
  name: 'iframe',
  tpl: function tpl(src) {
    return (0, _utils.tplReplace)(_index2.default, { src: src });
  }
};
...
(function (doc) {
  ...
  function render() {
    ...
    var iframeTpl = _iframe2.default.tpl(getCurrentNewsUrl());
  ...
  function renderFollowTpl() {
    ...
    var currentNews = JSON.parse(localStorage.getItem('currentNews') || '{}');
    var isExists = followList.find(function (news) {
      return news.uniquekey === currentNews.uniquekey;
    });
    console.log(isExists);
    return isExists ? _Follow2.default.follow() : _Follow2.default.unfollow();
  }
  ...
  function doFollow(follow) {
    ...
    if (follow) {
      ...
      followList = followList.filter(function (news) {
        return news.uniquekey !== currentNews.uniquekey;
      });
    }
...
/******/ });
//# sourceMappingURL=detail_04115a97.js.map